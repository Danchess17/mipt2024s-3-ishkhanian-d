...
def rotation3d(image, theta_x, theta_y, theta_z, show=False):
  ...
  euler_transform = sitk.Euler3DTransform((90.5, 108.5, 90.5), theta_x, theta_y, theta_z, (0, 0, 0))
  # print(euler_transform.GetDimension())
...
#   input("Press enter to continue...")
  rot_img = rotation3d(img, -45, 0, 0, show=True)
  rotated_sitk_image = sitk.GetImageFromArray(sitk.GetArrayFromImage(rot_img))
  sitk.WriteImage(rotated_sitk_image, "rotated_by_deg/1_rotated_by_-45.nii.gz")