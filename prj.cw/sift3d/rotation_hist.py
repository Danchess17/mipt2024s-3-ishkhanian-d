...
for right_border in np.arange(0, 100, bin_size):
    cmd = 'python3 rotation_matchreader.py {} {} {}'.format(deg, right_border, right_border + bin_size)
...
plt.bar(list(map_num_in_bin.keys()), map_num_in_bin.values())  
